  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Categoría de Socio</li>
      </ol>
      <div class="row">
        <div class="col-12">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <div class="btn-group pull-right">
            <div>
              <button type="button" class="btn btn-info " data-toggle="modal" data-target="#Modal-alta-categoria" > 
                <span class="glyphicon glyphicon-plus"></span> Nueva Categoría
              </button>    
            </div>
              <?php include('modal/Modal-alta-categoria.php'); ?>
    ...
    <!-- Custom scripts for all pages-->
      ...
      <script type="text/javascript" src="js/socio_categoria.js"></script> 
